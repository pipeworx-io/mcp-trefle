...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/trefle_search_plants \
  -H 'Content-Type: application/json' \
  -d '{"query":"tomato"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/trefle_search_plants`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
